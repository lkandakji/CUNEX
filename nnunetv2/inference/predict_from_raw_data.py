...
if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, 'Dataset001_name/nnUNetTrainer__nnUNetPlans__2d'),
        use_folds=(1,),
        checkpoint_name='checkpoint_best.pth',
    )
    predictor.predict_from_files(join(nnUNet_raw, 'Dataset001_name/imagesTs'),
                                 join(nnUNet_raw, 'Dataset001_name/imagesTs_pred'),
    ...
    # img, props = SimpleITKIO().read_images([join(nnUNet_raw, 'Dataset001_external/images_nii')])
